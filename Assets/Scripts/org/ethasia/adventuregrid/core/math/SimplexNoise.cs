...
namespace Org.Ethasia.Adventuregrid.Core.Math
{
    public class SimplexNoise
    {
        ...
        private static readonly short[] permutation = new short[512];
        private static readonly short[] permutationMod12 = new short[512];

        private static readonly double F2 = 0.5 * (System.Math.Sqrt(3.0) - 1.0);
        private static readonly double G2 = (3.0 - System.Math.Sqrt(3.0)) / 6.0;
        private static readonly double F3 = 1.0 / 3.0;
        private static readonly double G3 = 1.0 / 6.0;
        private static readonly double F4 = (System.Math.Sqrt(5.0) - 1.0) / 4.0;
        private static readonly double G4 = (5.0 - System.Math.Sqrt(5.0)) / 20.0;   
        ...
        public static double Noise(double x, double y, double z, double w) 
        {
            ...
            int kk = k & 255;
            int ll = l & 255;
            int gi0 = permutation[ii + permutation[jj + permutation[kk + permutation[ll]]]] % 32;
            int gi1 = permutation[ii + i1 + permutation[jj + j1 + permutation[kk + k1 + permutation[ll + l1]]]] % 32;
            int gi2 = permutation[ii + i2 + permutation[jj + j2 + permutation[kk + k2 + permutation[ll + l2]]]] % 32;
            int gi3 = permutation[ii + i3 + permutation[jj + j3 + permutation[kk + k3 + permutation[ll + l3]]]] % 32;
            int gi4 = permutation[ii + 1 + permutation[jj + 1 + permutation[kk + 1 + permutation[ll + 1]]]] % 32;
