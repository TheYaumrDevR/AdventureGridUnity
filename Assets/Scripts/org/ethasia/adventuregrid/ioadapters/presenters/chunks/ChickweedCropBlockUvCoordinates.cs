namespace Org.Ethasia.Adventuregrid.Ioadapters.Presenters.Chunks
{
    public class ChickweedCropBlockUvCoordinates : BlockUvCoordinates
    {
        ...
        private readonly float[] uvCoordinates = {
            0.9f, 0, 7, 0.9f, 0.2f, 7, 0.1f, 0.2f, 7, 0.1f, 0, 7, // Front 
            0.9f, 0, 7, 0.9f, 0.2f, 7, 0.1f, 0.2f, 7, 0.1f, 0, 7, // Right
            0.9f, 0, 7, 0.9f, 0.2f, 7, 0.1f, 0.2f, 7, 0.1f, 0, 7, // Back
            0.9f, 0, 7, 0.9f, 0.2f, 7, 0.1f, 0.2f, 7, 0.1f, 0, 7, // Left
        ...
        private readonly float[] backUvCoordinates = {
            0.1f, 0, 7, 0.1f, 0.2f, 7, 0.9f, 0.2f, 7, 0.9f, 0, 7, // Front
            0.1f, 0, 7, 0.1f, 0.2f, 7, 0.9f, 0.2f, 7, 0.9f, 0, 7, // Right
            0.1f, 0, 7, 0.1f, 0.2f, 7, 0.9f, 0.2f, 7, 0.9f, 0, 7, // Back
            0.1f, 0, 7, 0.1f, 0.2f, 7, 0.9f, 0.2f, 7, 0.9f, 0, 7, // Left
